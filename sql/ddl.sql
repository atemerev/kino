...
CREATE TYPE relationship_status AS ENUM ('single', 'married', 'in_relationship', 'engaged', 'divorced', 'separated', 'its_complicated', 'widowed', 'domestic_partnership', 'open_relationship', 'civil_union');
